...
下载vscode，并且在插件中找到 Cline![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnrw0P6NOnUfUJMKjgBTUtUCsJ6TgULjU9KMACszmFmuSknIbhtdYWB2g/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=14)点击上方配置MCP Server，我们可以使用第三方的，也可以使用自己编写的。![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnr4aKAAosmuoKZQWQ8iaHqxVdjj712yD8nYKQIkUc3SrZXzicCzVTD2oew/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=15)点击 installed 进行配置

![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnrv2nAiaRRUIcd5OV848OOj6UW8sOJk7mibGUMmwibd3bpeiagEZBWoKiaPpQ/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=16)![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnrFOZMLthdIHkHwypLk6JKoicibuZ5HYvNjuwRibuKPwEWALcb1pgwqJib6g/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=17)点击Done即可，这个服务地址就是我们编写的MCP Server，下面我们来讲讲MCP Server的构建
...
当我们让LLM发邮件的时候![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnrVb8SfEs8xFkVpPN6RRkhwFqBD4DicZ9lNicRfbs5jh9dXuaEBTibKc1Jw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=18)LLM获取了我们的批准后便开始发邮件。![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnrUSFzQiaBEbEMDTuBYbwbnDqTztic9IKDupsW9BH5J7cq8Hw9x8qO85WA/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=19)发送成功的返回![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnrTh4f3Ex9K2T5cXrWmCcbgUmrlRB4ibVwI698ia04taTmDgYVwKkhkJAw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=20)效果：![在这里插入图片描述](https://mmbiz.qpic.cn/mmbiz_png/UBiaA4ibmWk2bODVfibz2H1FwfUBQVIplnrhC6yZJ0hMofhO7KDjVXibQRf4pteY0pBBtSXmDQvhDKJyCBFUVOdZ6g/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=21)
